    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-80" align="end" forceMount>
        ...
        <div className="px-3 py-2">
          <div className="text-[11px] text-foreground/60 mb-2">选择头像</div>
          <div className="grid grid-cols-6 gap-2">
            {AVATARS.map((url) => (
              <button
                ...
                className={`rounded border ${avatar === url ? 'border-blue-500' : 'border-transparent'} hover:border-blue-400 p-0.5`}
