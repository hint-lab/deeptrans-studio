...
export class DiscourseQueryAgent extends BaseAgent<{ source: string; tenantId?: string; prompt?: string; locale?: string }, { hits: MemoryHit[] }> {
  ...
  async execute(input: { source: string; tenantId?: string; prompt?: string }, _ctx?: AgentRunContext): Promise<{ hits: MemoryHit[] }> {
