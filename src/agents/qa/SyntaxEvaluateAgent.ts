...
export class SyntaxEvaluateAgent extends BaseAgent<{ source: string; target: string; targetLanguage?: string; domain?: string; prompt?: string; locale?: string }, any> {
  ...
  async execute(input: { source: string; target: string; targetLanguage?: string; domain?: string; prompt?: string; locale?: string }, ctx?: AgentRunContext): Promise<any> {
