    ...
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#0f1020] via-[#11122a] to-[#0b0c1a] text-white">
      ...
      <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 relative z-10">
        <div className="flex flex-col gap-4 md:gap-8">
          <h2 className="text-xl font-extrabold tracking-tight sm:text-[3rem]">{t("greeting")}</h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-8">
          <Link className="flex max-w-xs flex-col gap-4 rounded-xl bg-white/10 p-4 hover:bg-white/20" href="./auth/login">
          ...
          <Link className="flex max-w-xs flex-col gap-4 rounded-xl bg-white/10 p-4 hover:bg-white/20" href="./docs">
      ...
      <footer className="fixed bottom-0 w-full py-2 text-center text-sm text-white/70 z-10">
        {t("copyright", { year })}
        <br />
      </footer>
    </main>
