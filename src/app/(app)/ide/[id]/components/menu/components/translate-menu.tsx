...
export function TranslateMenu({ isTranslating, canTranslate, onTranslate, onBatchTranslate, progressPercent }: TranslateMenuProps) {
...
export function TranslateSubMenuItem({ isTranslating, onTranslate }: TranslateMenuItemProps) {
    ...
    return (
        <MenubarItem
            className={cn(
                "flex items-center px-3 py-2 text-sm relative overflow-hidden cursor-pointer",
